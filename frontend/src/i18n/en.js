...
export default {
  ...
  ejecutor: {
    ...
    placeholderTurno: 'Instruction for the next turn of this mission…',
    hint: 'The Executor runs verified commands on the selected machines (no customer data)',
    titulo: 'Executor',
    cargando: 'Loading…',
    maquinasTitulo: 'Machines',
    sinElegibles: 'No machine is eligible.',
    compuertaRotulo: 'Customer data gate',
    compuertaEstados: { cerrada: 'closed', abierta: 'open' },
    motivosNoElegible: {
      maquina_con_datos_de_clientes: 'Holds customer data',
      maquina_inactiva: 'Inactive',
    },
    pausaTitulo: 'Executor pause',
    pausaPuesta: 'Executor pause is on',
    pausaNoPuesta: 'Executor pause is off',
    pausaIlegible: 'The pause could not be read: treated as on.',
    pausaOrigen: 'Source',
    pausaMotivo: 'Reason',
    pausaPaso: 'Step',
    pausaMomento: 'Time',
    pausar: 'Pause the Executor',
    pausarAclaracion: 'Pauses only the Executor; this is not the global kill switch.',
    quitarPausa: 'Lift the pause',
    quitarPausaTitulo: 'Lift the Executor pause',
    quitarPausaMensaje: (motivo) => `The pause was set because: ${motivo}. Lift it only once you have checked the cause.`,
    quitarPausaConfirmar: 'Yes, lift the pause',
    sinMotivo: 'no reason given',
    origenes: { c5: 'live auditor (C5)', plataforma: 'platform' },
    motivosPausa: {
      pausa_manual: 'Manual pause from the platform',
      repuesta_sin_auditoria: 'Set again: lifting it could not be audited',
      vigia_caido: 'The watchdog is down',
      fuera_de_mision: 'Outside the mission',
      prohibido: 'Forbidden',
    },
    misionesTitulo: 'Recent missions',
    sinMisiones: 'No missions yet.',
    nuevaMision: 'New mission',
    turnosContados: (n) => `${n} ${n === 1 ? 'turn' : 'turns'}`,
    detalleTitulo: 'Mission details',
    sinMisionAbierta: 'Pick a mission, or type a goal below to create a new one.',
    puedeContinuar: 'What you type below is sent as the next turn of this mission.',
    noPuedeContinuar: 'This mission takes no more turns: what you type below creates a new mission.',
    maquinasDeMision: 'Machines',
    turno: (n) => `Turn ${n}`,
    ...
    rotuloComando: 'Command',
    rotuloLinea: 'Quoted line',
    descartadas: 'Discarded',
    crudas: 'Raw outputs',
    sinCrudas: 'This turn has no raw outputs.',
    truncada: 'truncated',
    verificacionTitulo: 'Verification',
    verificacion: {
      registro_cuadra: 'Log reconciles',
      cadena_ok: 'Chain intact',
      pausa_puesta: 'Pause on',
      auditor_pauso: 'Auditor paused',
      auditor_legible: 'Auditor readable',
    },
    si: 'yes',
    no: 'no',
    bitacora: 'Log',
    sinEventos: 'No events.',
    errorDeRed: 'The server did not respond.',
    errorHttp: (status) => `The server answered ${status}.`,
    estadosMision: {
      en_curso: 'Running',
    ...
    contratos: {
      c1: 'C1 · prohibitions (hook)',
      c2: 'C2 · backup before destroying',
      c3: 'C3 · tamper-proof log',
      c4: 'C4 · in-flight brake',
      c5: 'C5 · live auditor',
      c6: 'C6 · revocation',
      arranque: 'Conditional startup',
    },
    errores: {
      ...
      ejecutor_turno_en_curso: () => 'A turn is already running. Wait for it to finish.',
      ejecutor_pausado: () => 'The Executor is paused.',
    ...
    codigosTurno: {
      arranque_rechazado: 'Startup was rejected',
      pausa_puesta: 'The pause was on',
      auditor_pauso: 'The auditor paused the turn',
      vigia_no_latio: 'The watchdog missed its heartbeat',
      cerebro_fallo: 'The brain failed',
      registro_no_cuadra: 'The log does not reconcile',
      cadena_rota: 'The chain is broken',
      vigia_no_cerro: 'The watchdog did not close',
      runner_salida_invalida: 'The runner returned invalid output',
      runner_sin_cierre: 'The runner ended without closing',
      plataforma_reiniciada: 'The platform restarted during the turn',
      sin_configurar: 'The Executor is not configured',
      cerebro_tope_vencido: 'The brain exceeded its time limit',
    ...
    eventos: {
      ...
      turno_lanzado: 'Turn launched',
      arranque_rechazado: 'Startup rejected',
      arranque_verificado: 'Startup verified',
      vigia_late: 'Watchdog heartbeat',
      vigia_no_latio: 'Watchdog missed heartbeat',
      cerebro_termino: 'Brain finished',
      paso: 'Step',
      afirmacion_entregada: 'Claim delivered',
      afirmacion_descartada: 'Claim discarded',
      auditor_pauso: 'Auditor paused',
      vigia_cerrado: 'Watchdog closed',
      pausa_detectada: 'Pause detected',
      turno_completado: 'Turn completed',
      turno_fallido: 'Turn failed',
      turno_interrumpido: 'Turn interrupted',
      turno_rechazado: 'Turn rejected',
      auditor_ilegible: 'Auditor unreadable',
      runner_salida_invalida: 'Invalid runner output',
    },
    codigos: {
      respaldada: 'Backed',
      sin_respaldo: 'Not backed',
      fuente_truncada: 'The source is truncated',
      fuente_inexistente: 'The source does not exist',
      dato_fuera_de_linea: 'The value is not in the line',
      verificador_caido: 'The verifier is down',
      linea_vacia: 'Empty line',
      maquina_vacia: 'Empty machine',
      dato_vacio: 'Empty value',
      proposito_vacio: 'Empty purpose',
      dato_no_entero: 'The value is not an integer',
      linea_no_esta: 'The line is not in the output',
      comando_no_corrido: 'The command was not run',
      retenida_por_auditor: 'Held back by the auditor',
      auditor_ilegible: 'The auditor could not be read',
      fuera_de_mision: 'Outside the mission',
      prohibido: 'Forbidden',
      solucion_temporal: 'Temporary workaround',
      hardcoding: 'Hardcoding',
      cierre_sin_verificacion: 'Closed without verification',
      vigia_caido: 'The watchdog is down',
      instalado_distinto_del_repo: 'The installed copy differs from the repository',
      maquina_fuera_del_inventario: 'Machine outside the inventory',
      maquina_sin_contratos_remotos: 'Machine without remote contracts',
      freno_sin_latido: 'The brake has no heartbeat',
      interruptor_puesto: 'The switch is on',
      freno_sin_cuenta: 'The brake has no account',
      freno_no_habilitado: 'The brake is not enabled',
      cron_abierto_para_la_cuenta: 'Cron is open for the account',
      linger_activo: 'Linger is enabled',
      pausa_del_ejecutor_puesta: 'The Executor pause is on',
      vigia_ya_activo: 'The watchdog is already running',
      cuenta_inalcanzable: 'Account unreachable',
      cerco_alcanza_maquina_sin_contratos: 'The fence reaches a machine without contracts',
      maquina_inalcanzable: 'Machine unreachable',
      exportacion_imposible: 'Export impossible',
      prueba_ausente: 'The test is missing',
      prueba_reventada: 'The test crashed',
      auditor_no_admite_datos_de_clientes: 'The auditor does not accept machines with customer data',
    },
  },

  // Memory screen — Task 6, plan 2026-09-20-memoria-admin.md, spec
  // 2026-09-18-memoria-admin-design.md. Provenance shows ALWAYS, even empty.
  // Expiring and correcting are destructive: they go through ConfirmacionSuma,
  // never confirm()/alert()/prompt().
  memoria: {
    titulo: 'Memory',
    ...
    aprobarSeleccionados: (n) => `Approve selected (${n})`,
    // Accessibility (2.4.6/3.3.2): each fact's checkbox needs to say WHAT IT
    // SELECTS FOR, not just the bare fact number.
    seleccionarHecho: (id) => `Select fact #${id} for batch approval`,
    aprobando: 'Approving…',
    aprobados: (n) => (n === 1 ? '1 fact approved.' : `${n} facts approved.`),
    aprobar: 'Approve',
    casiDuplicados: (n) => `These ${n} facts say the same thing`,
    fundir: 'Approve the most recent and expire the rest',
    fundirTitulo: 'Merge near-duplicates',
    fundirMensaje: 'The most recent wording gets approved and the rest gets expired: nothing is deleted.',
    fundirConfirmar: 'Merge',
    fundido: 'Near-duplicates resolved.',
    corregir: 'Correct',
    corregirTitulo: (id) => `Correct fact #${id}`,
    corregirTexto: 'Corrected text',
    corregirGuardar: 'Continue',
    corregirCancelar: 'Cancel',
    corregirVacio: 'Write the corrected text.',
    corregirConfirmarTitulo: 'Confirm correction',
    corregirConfirmarMensaje: 'The current fact is marked as superseded, not deleted: the new version enters unverified.',
    corregirConfirmarBoton: 'Correct',
    corregido: 'Fact corrected.',
    caducar: 'Expire',
    caducarTitulo: 'Expire fact',
    caducarMensaje: 'The fact stops counting in search. It is not deleted: it stays visible, marked as expired.',
    caducarConfirmar: 'Expire',
    caducado: 'Fact expired.',
    quitarCaducidad: 'Remove expiration',
    caducidadQuitada: 'Expiration removed.',
    procedencia: {
      mensaje: 'Message',
      faceta: 'Facet',
      sinMensaje: 'no source message',
      sinFaceta: 'no facet recorded',
    },
    tipo: 'Type',
    confianza: 'Confidence',
    creado: 'Created',
    verificadoPor: (id) => `Verified by #${id}`,
    verificado: 'Verified',
    sinVerificar: 'Unverified',
    vencido: 'Expired',
    vence: (fecha) => `Expires ${fecha}`,
    ...
    errores: {
      hecho_no_encontrado: 'The fact no longer exists: reload the screen.',
