...
describe('Ejecutor -- textos', () => {
  ...
  const TURNO = ['arranque_rechazado', 'pausa_puesta', 'auditor_pauso', 'vigia_no_latio', 'cerebro_fallo', 'registro_no_cuadra', 'cadena_rota', 'vigia_no_cerro', 'runner_salida_invalida', 'runner_sin_cierre', 'plataforma_reiniciada', 'sin_configurar', 'cerebro_tope_vencido', 'auditor_ilegible', 'turno_ilegible', 'runner_error']
