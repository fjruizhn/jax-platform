"""JAX_SEED_ADMIN_PASSWORD (fix del hardcode "***REMOVED-SEE-JAX-RONDA9-2026-08-20***" en db/seed.py, ronda
...
def test_resolve_seed_admin_password_generates_and_logs_when_unset(monkeypatch, caplog):
    ...
    assert generated != "***REMOVED-SEE-JAX-RONDA9-2026-08-20***"
...
def test_resolve_seed_admin_password_never_returns_known_default(monkeypatch):
    ...
    assert "***REMOVED-SEE-JAX-RONDA9-2026-08-20***" not in seen
