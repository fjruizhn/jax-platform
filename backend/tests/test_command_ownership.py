...
from api.command import MISSIONS_DIR, _owner_file, get_command_result
...
def owned_task():
    ...
    _owner_file(task_id).unlink(missing_ok=True)
...
async def test_task_with_no_owner_file_404s_even_if_result_exists():
